...
class ViewController: UIViewController, EPCalendarPickerDelegate {
    ...
    @IBOutlet var btnShowMeCalendar: UIButton!
    ...
    @IBAction func onTouchShowMeCalendarButton(_: AnyObject) {
...
//        calendarPicker.backgroundColor = UIColor.blueColor()
    ...
    func epCalendarPicker(_: EPCalendarPicker, didCancel _: NSError) {
